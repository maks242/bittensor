...
class server(torch.nn.Module):
    ...
    def config ():
        ...
        parser.add_argument('--create_instances', type=int, help='Specify number of the instances to spawn', default = 1)
        parser.add_argument('--wallet.hotkey.id', type=int, help='Specify offset of the first instance to spawn', default = 0)
        # ML model arguements
